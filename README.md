...
--------------------
 ...
 - [Symphony Media Bridge WHIP Gateway](https://app.osaas.io/dashboard/service/eyevinn-smb-whip-bridge)
...
### Brave
- [[SRC](https://github.com/bbc/brave) | [DOCS](https://github.com/bbc/brave/blob/master/docs/faq.md)]
...
- [[SRC](https://github.com/Eyevinn/channel-engine-bridge) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-Channel-Engine-Bridge.html)]
...
### Chaos Stream Proxy
- [[SRC](https://github.com/Eyevinn/chaos-stream-proxy) | [DOCS](https://eyevinntechnology.medium.com/delivering-flawless-streams-regardless-of-the-challenges-in-network-conditions-e466bad5b83f)]
...
### Chromecast receiver
- [[SRC](https://github.com/Eyevinn/cast-receiver) | [DOCS](https://github.com/Eyevinn/cast-receiver)]
...
- [[SRC](https://github.com/Eyevinn/continue-watching-api) | [DOCS](https://dev.to/video/how-to-quickly-setup-a-continue-watching-endpoint-for-your-video-players-ek7)]
...
### EasyVMAF
- [[SRC](https://github.com/Eyevinn/easyvmaf_s3) ]
...
### Encore Packager
- [[SRC](https://github.com/Eyevinn/encore-packager) ]
...
### Encore Transfer
- [[SRC](https://github.com/Eyevinn/encore-transfer) ]
...
- [[SRC](https://github.com/Eyevinn/live-encoding) ]
...
### FAST Channel Engine
- [[SRC](https://github.com/Eyevinn/docker-fast) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-FAST-Channel-Engine.html)]
...
- [[SRC](https://github.com/Eyevinn/schedule-service) ]

A modular service to automatically populate schedules for FAST Engine channels. Uses AWS Dynamo DB as database.
### Fathom Lite
- [[SRC](https://github.com/usefathom/fathom) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-Fathom-Lite.html)]
...
### flyimg
- [[SRC](https://github.com/flyimg/flyimg) | [DOCS](https://github.com/flyimg/flyimg)]
...
- [[SRC](https://github.com/Eyevinn/preview-hls-service) | [DOCS](https://github.com/Eyevinn/preview-hls-service)]

A service to generate a preview video (mp4) or an image (png) from an HLS stream
### HLS Stream Monitor
- [[SRC](https://github.com/Eyevinn/hls-monitor) | [DOCS](https://github.com/Eyevinn/hls-monitor)]

Service to monitor one or more HLS-streams for manifest errors and inconsistencies.
### HLS VOD Stitcher
- [[SRC](https://github.com/Eyevinn/lambda-stitch) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-HLS-VOD-Stitcher.html)]

A proxy to insert ads in an HLS VOD either using manifest manipulation or HLS interstitials
### Intercom
- [[SRC](https://github.com/Eyevinn/intercom-manager) | [DOCS](https://docs.osaas.io/osaas.wiki/User-Guide%3A-Cloud-Intercom.html)]
...
### Kings and Pigs
- [[SRC](https://github.com/bwallberg/kings-and-pigs-ts) ]
...
### lambda
- [[SRC](https://github.com/birme/lambda) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-Birme-Lambda.html)]
...
### Livego
- [[SRC](https://github.com/gwuhaolin/livego) ]
...
### livesim2
- [[SRC](https://github.com/Dash-Industry-Forum/livesim2) ]
...
### MariaDB
- [[SRC](https://github.com/linuxserver/docker-mariadb) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-MariaDB.html)]
...
### Media Probe
- [[SRC](https://github.com/Eyevinn/function-probe) | [DOCS](https://github.com/Eyevinn/function-probe)]

A serverless media function to obtain media information for a media file or media stream.
### Minecraft Server
- [[SRC](https://github.com/itzg/docker-minecraft-server) ]
...
### minio
- [[SRC](https://github.com/minio/minio) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-MinIO.html)]
...
### MOE Replay
- [[SRC](https://github.com/realeyes-media/moe-replay) ]
...
### movierecommendator
- [[SRC](https://github.com/alexbj75/movierecommendator) ]
...
### OSC Command
- [[SRC](https://github.com/Eyevinn/osaas-client-ts) ]

Unlock the full potential by orchestrating other Open Source Cloud services and jobs with the OSC CLI as an OSC job.
### owncast
- [[SRC](https://github.com/owncast/owncast) | [DOCS](https://owncast.online/quickstart/configure/)]
...
- [[SRC](https://github.com/restorecommerce/pdf-rendering-srv) | [DOCS](https://docs.restorecommerce.io/pdf-rendering-srv/index.html)]
...
- [[SRC](https://github.com/smrchy/rest-rsmq) ]
...
### restreamer
- [[SRC](https://github.com/datarhei/restreamer) ]
...
### Retransfer
- [[SRC](https://github.com/Eyevinn/docker-retransfer) ]
...
- [[SRC](https://github.com/Eyevinn/function-scenes) | [DOCS](https://github.com/Eyevinn/function-scenes)]

A serverless media function to detect scene changes and extract keyframes in a video file or a stream.
### sftpgo
- [[SRC](https://github.com/drakkan/sftpgo) ]
...
### Shaka Packager
- [[SRC](https://github.com/Eyevinn/shaka-packager-s3) ]
...
- [[SRC](https://github.com/Eyevinn/rust-image-processor) | [DOCS](https://github.com/Eyevinn/rust-image-processor)]

An efficient and easy to use image resizer offering an endpoint for scaling image on the fly.
### Simple Realtime Server
- [[SRC](https://github.com/ossrs/srs) ]
...
Get started easily!
### SmoothMQ
- [[SRC](https://github.com/poundifdef/SmoothMQ) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-SmoothMQ.html)]
...
### SRT WHEP Bridge
- [[SRC](https://github.com/Eyevinn/srt-whep) ]
...
### Subtitle Generator
- [[SRC](https://github.com/Eyevinn/auto-subtitles) | [DOCS](https://github.com/Eyevinn/auto-subtitles#endpoints)]

Automatically generate subtitles from an input audio or video file using Open AI Whisper.
### SVT Encore
- [[SRC](https://github.com/svt/encore) | [DOCS](https://docs.osaas.io/osaas.wiki/Solution%3A-VOD-Transcoding.html)]
...
### Swagger Editor
- [[SRC](https://github.com/swagger-api/swagger-editor) ]
...
- [[SRC](https://github.com/Eyevinn/wrtc-egress) ]
...
- [[SRC](https://github.com/Eyevinn/smb-whip-bridge) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-Symphony-Media-Bridge-WHIP-Gateway.html)]
...
### Test Adserver
- [[SRC](https://github.com/Eyevinn/test-adserver) | [DOCS](https://github.com/Eyevinn/test-adserver)]
...
### Trim Media
- [[SRC](https://github.com/Eyevinn/function-trim) ]
...
### valkey
- [[SRC](https://github.com/valkey-io/valkey) ]
