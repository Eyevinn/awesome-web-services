...
### [Brave](#bbc-brave) [[SRC](https://github.com/bbc/brave) | [DOCS](https://github.com/bbc/brave/blob/master/docs/faq.md)]
...
### [Channel Engine Bridge](#eyevinn-channel-engine-bridge) [[SRC](https://github.com/Eyevinn/channel-engine-bridge) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-Channel-Engine-Bridge.html)]
...
### [Chaos Stream Proxy](#eyevinn-chaos-stream-proxy) [[SRC](https://github.com/Eyevinn/chaos-stream-proxy) | [DOCS](https://eyevinntechnology.medium.com/delivering-flawless-streams-regardless-of-the-challenges-in-network-conditions-e466bad5b83f)]
...
### [Chromecast receiver](#eyevinn-cast-receiver) [[SRC](https://github.com/Eyevinn/cast-receiver) | [DOCS](https://github.com/Eyevinn/cast-receiver)]
...
### [Continue Watching Service](#eyevinn-continue-watching-api) [[SRC](https://github.com/Eyevinn/continue-watching-api) | [DOCS](https://dev.to/video/how-to-quickly-setup-a-continue-watching-endpoint-for-your-video-players-ek7)]
...
### [EasyVMAF](#eyevinn-easyvmaf-s3) [[SRC](https://github.com/Eyevinn/easyvmaf_s3) ]
...
### [Encore Callback Listener](#eyevinn-encore-callback-listener) [[SRC](https://github.com/Eyevinn/encore-callback-listener) ]
...
### [Encore Packager](#eyevinn-encore-packager) [[SRC](https://github.com/Eyevinn/encore-packager) ]
...
### [Encore Transfer](#eyevinn-encore-transfer) [[SRC](https://github.com/Eyevinn/encore-transfer) ]
...
### [Eyevinn Live Encoding](#eyevinn-live-encoding) [[SRC](https://github.com/Eyevinn/live-encoding) ]
...
### [FAST Channel Engine](#channel-engine) [[SRC](https://github.com/Eyevinn/docker-fast) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-FAST-Channel-Engine.html)]
...
### [FAST Engine Schedule Service](#eyevinn-schedule-service) [[SRC](https://github.com/Eyevinn/schedule-service) ]

A modular service to automatically populate schedules for FAST Engine channels. Uses AWS Dynamo DB as database.
### [Fathom Lite](#usefathom-fathom) [[SRC](https://github.com/usefathom/fathom) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-Fathom-Lite.html)]
...
### [flyimg](#flyimg-flyimg) [[SRC](https://github.com/flyimg/flyimg) | [DOCS](https://github.com/flyimg/flyimg)]
...
### [HLS Preview Generator](#eyevinn-preview-hls-service) [[SRC](https://github.com/Eyevinn/preview-hls-service) | [DOCS](https://github.com/Eyevinn/preview-hls-service)]

A service to generate a preview video (mp4) or an image (png) from an HLS stream
### [HLS Stream Monitor](#eyevinn-hls-monitor) [[SRC](https://github.com/Eyevinn/hls-monitor) | [DOCS](https://github.com/Eyevinn/hls-monitor)]

Service to monitor one or more HLS-streams for manifest errors and inconsistencies.
### [HLS VOD Stitcher](#eyevinn-lambda-stitch) [[SRC](https://github.com/Eyevinn/lambda-stitch) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-HLS-VOD-Stitcher.html)]

A proxy to insert ads in an HLS VOD either using manifest manipulation or HLS interstitials
### [Intercom](#eyevinn-intercom-manager) [[SRC](https://github.com/Eyevinn/intercom-manager) | [DOCS](https://docs.osaas.io/osaas.wiki/User-Guide%3A-Cloud-Intercom.html)]
...
### [Kings and Pigs](#bwallberg-kings-and-pigs-ts) [[SRC](https://github.com/bwallberg/kings-and-pigs-ts) ]
...
### [lambda](#birme-lambda) [[SRC](https://github.com/birme/lambda) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-Birme-Lambda.html)]
...
### [Livego](#gwuhaolin-livego) [[SRC](https://github.com/gwuhaolin/livego) ]
...
### [livesim2](#dash-industry-forum-livesim2) [[SRC](https://github.com/Dash-Industry-Forum/livesim2) ]
...
### [MariaDB](#linuxserver-docker-mariadb) [[SRC](https://github.com/linuxserver/docker-mariadb) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-MariaDB.html)]
...
### [Media Probe](#eyevinn-function-probe) [[SRC](https://github.com/Eyevinn/function-probe) | [DOCS](https://github.com/Eyevinn/function-probe)]

A serverless media function to obtain media information for a media file or media stream.
### [Minecraft Server](#itzg-docker-minecraft-server) [[SRC](https://github.com/itzg/docker-minecraft-server) ]
...
### [minio](#minio-minio) [[SRC](https://github.com/minio/minio) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-MinIO.html)]
...
### [MOE Replay](#realeyes-media-moe-replay) [[SRC](https://github.com/realeyes-media/moe-replay) ]
...
### [movierecommendator](#alexbj75-movierecommendator) [[SRC](https://github.com/alexbj75/movierecommendator) ]
...
### [OSC Command](#eyevinn-osaas-client-ts) [[SRC](https://github.com/Eyevinn/osaas-client-ts) ]

Unlock the full potential by orchestrating other Open Source Cloud services and jobs with the OSC CLI as an OSC job.
### [owncast](#owncast-owncast) [[SRC](https://github.com/owncast/owncast) | [DOCS](https://owncast.online/quickstart/configure/)]
...
### [PDF Rendering Service](#restorecommerce-pdf-rendering-srv) [[SRC](https://github.com/restorecommerce/pdf-rendering-srv) | [DOCS](https://docs.restorecommerce.io/pdf-rendering-srv/index.html)]
...
### [Really Simple Message Queue](#smrchy-rest-rsmq) [[SRC](https://github.com/smrchy/rest-rsmq) ]
...
### [restreamer](#datarhei-restreamer) [[SRC](https://github.com/datarhei/restreamer) ]
...
### [Retransfer](#eyevinn-docker-retransfer) [[SRC](https://github.com/Eyevinn/docker-retransfer) ]
...
### [Scene Detect Media Function](#eyevinn-function-scenes) [[SRC](https://github.com/Eyevinn/function-scenes) | [DOCS](https://github.com/Eyevinn/function-scenes)]

A serverless media function to detect scene changes and extract keyframes in a video file or a stream.
### [sftpgo](#drakkan-sftpgo) [[SRC](https://github.com/drakkan/sftpgo) ]
...
### [Shaka Packager](#eyevinn-shaka-packager-s3) [[SRC](https://github.com/Eyevinn/shaka-packager-s3) ]
...
### [Simple Image Resizer](#eyevinn-rust-image-processor) [[SRC](https://github.com/Eyevinn/rust-image-processor) | [DOCS](https://github.com/Eyevinn/rust-image-processor)]

An efficient and easy to use image resizer offering an endpoint for scaling image on the fly.
### [Simple Realtime Server](#ossrs-srs) [[SRC](https://github.com/ossrs/srs) ]
...
Get started easily!
### [SmoothMQ](#poundifdef-smoothmq) [[SRC](https://github.com/poundifdef/SmoothMQ) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-SmoothMQ.html)]
...
### [SRT WHEP Bridge](#eyevinn-srt-whep) [[SRC](https://github.com/Eyevinn/srt-whep) ]
...
### [Subtitle Generator](#eyevinn-auto-subtitles) [[SRC](https://github.com/Eyevinn/auto-subtitles) | [DOCS](https://github.com/Eyevinn/auto-subtitles#endpoints)]

Automatically generate subtitles from an input audio or video file using Open AI Whisper.
### [SVT Encore](#encore) [[SRC](https://github.com/svt/encore) | [DOCS](https://docs.osaas.io/osaas.wiki/Solution%3A-VOD-Transcoding.html)]
...
### [Swagger Editor](#swagger-api-swagger-editor) [[SRC](https://github.com/swagger-api/swagger-editor) ]
...
### [Symphony Media Bridge WHEP Gateway](#eyevinn-wrtc-egress) [[SRC](https://github.com/Eyevinn/wrtc-egress) ]
...
### [Symphony Media Bridge WHIP Gateway](#eyevinn-smb-whip-bridge) [[SRC](https://github.com/Eyevinn/smb-whip-bridge) | [DOCS](https://docs.osaas.io/osaas.wiki/Service%3A-Symphony-Media-Bridge-WHIP-Gateway.html)]
...
### [Test Adserver](#eyevinn-test-adserver) [[SRC](https://github.com/Eyevinn/test-adserver) | [DOCS](https://github.com/Eyevinn/test-adserver)]
...
### [Trim Media](#eyevinn-function-trim) [[SRC](https://github.com/Eyevinn/function-trim) ]
...
### [valkey](#valkey-io-valkey) [[SRC](https://github.com/valkey-io/valkey) ]
